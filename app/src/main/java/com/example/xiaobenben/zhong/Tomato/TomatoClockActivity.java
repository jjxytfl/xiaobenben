...
public class TomatoClockActivity extends AppCompatActivity {
    ...
    static TomatoClockActivity mInstance = null;
        ...
        new AlertDialog.Builder(this).setTitle("停止番茄钟").setMessage("是否停止番茄钟?")
                .setPositiveButton("是的", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        PendingIntent pendingIntent = PendingIntent.getBroadcast(TomatoClockActivity.this, 0, new Intent(TomatoClockActivity.this, TimeOutReceiver.class), 0);
                        AlarmManager.AlarmClockInfo next = alarmManager.getNextAlarmClock();
                        if (null != next) {
                            alarmManager.cancel(pendingIntent);
                        }
                        //startActivity(new Intent(TomatoClockActivity.this,MainActivity.class));
                        finish();
                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("12345", "onClick: " + startTime);
        entries = SpUtils.getCurrent();
        Log.d("12345", "onClick: enteies.size " + entries.size());
